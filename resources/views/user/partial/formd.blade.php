	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text('apelido', null, ['class' => 'form-control', 'readonly']) !!}
		</div>
	</div>
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::select('sexo_id', $sex, null, ['class' => 'form-control', 'disabled']) !!}
		</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
			...
			{!! Form::text('git', null, ['class' => 'form-control', 'readonly']) !!}
		</div>
	</div>
